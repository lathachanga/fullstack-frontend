...
export default function AddTodo() {
    ...
    const onSubmit= async (e)=>{
         e.preventDefault();
        await axios.post("http://localhost:8080/add",todo)
        navigate("/")
    };
   return (
    <div className="container">
        <div className="row">
            <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
                <h2 className="text-center m-4">Creating Todo</h2>
                ...
                <div className="mb-3">
                    ...
                    <input type={"text"} className="form-control" placeholder="Enter true or false" name="completed" value={completed}  onChange={(e)=>onInputChange(e)}/>
                </div>
                <div className="mb-3">
